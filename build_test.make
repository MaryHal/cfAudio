...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/build_test
  TARGETDIR  = bin
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/build_test
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/linux_Test32
  DEFINES   += 
  INCLUDES  += -Isrc
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/build_test
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/linux_Test64
  DEFINES   += -DDEBUG
  INCLUDES  += -Isrc
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/build_test
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/linux_Test64
  DEFINES   += 
  INCLUDES  += -Isrc
